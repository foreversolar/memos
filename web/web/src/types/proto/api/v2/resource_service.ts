...
export interface GetResourceByNameRequest {
  name: string;
}

export interface GetResourceByNameResponse {
  resource?: Resource | undefined;
}
...
export const Resource = {
  encode(message: Resource, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.memoId !== undefined) {
      writer.uint32(64).int32(message.memoId);
    }
    return writer;
  },
...
export const GetResourceResponse = {
  ...
  create(base?: DeepPartial<GetResourceResponse>): GetResourceResponse {
    return GetResourceResponse.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<GetResourceResponse>): GetResourceResponse {
    const message = createBaseGetResourceResponse();
    message.resource = (object.resource !== undefined && object.resource !== null)
      ? Resource.fromPartial(object.resource)
      : undefined;
...
function createBaseGetResourceByNameRequest(): GetResourceByNameRequest {
  return { name: "" };
}

export const GetResourceByNameRequest = {
  encode(message: GetResourceByNameRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetResourceByNameRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetResourceByNameRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  create(base?: DeepPartial<GetResourceByNameRequest>): GetResourceByNameRequest {
    return GetResourceByNameRequest.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<GetResourceByNameRequest>): GetResourceByNameRequest {
    const message = createBaseGetResourceByNameRequest();
    message.name = object.name ?? "";
    return message;
  },
...
function createBaseGetResourceByNameResponse(): GetResourceByNameResponse {
  return { resource: undefined };
}

export const GetResourceByNameResponse = {
  encode(message: GetResourceByNameResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.resource !== undefined) {
      Resource.encode(message.resource, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetResourceByNameResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetResourceByNameResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  create(base?: DeepPartial<GetResourceByNameResponse>): GetResourceByNameResponse {
    return GetResourceByNameResponse.fromPartial(base ?? {});
  },

  fromPartial(object: DeepPartial<GetResourceByNameResponse>): GetResourceByNameResponse {
    const message = createBaseGetResourceByNameResponse();
    message.resource = (object.resource !== undefined && object.resource !== null)
      ? Resource.fromPartial(object.resource)
      : undefined;
...
export const ResourceServiceDefinition = {
  ...
  methods: {
    ...
    getResourceByName: {
      ...
      requestType: GetResourceByNameRequest,
      requestStream: false,
      responseType: GetResourceByNameResponse,
      responseStream: false,
      options: {
        _unknownFields: {

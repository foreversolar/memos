...
export enum UserSettingKey {
  ...
  /** USER_SETTING_LOCALE - The locale of the user. */
  USER_SETTING_LOCALE = 2,
  /** USER_SETTING_APPEARANCE - The appearance of the user. */
  USER_SETTING_APPEARANCE = 3,
  /** USER_SETTING_MEMO_VISIBILITY - The visibility of the memo. */
  USER_SETTING_MEMO_VISIBILITY = 4,
  /** USER_SETTING_TELEGRAM_USER_ID - The telegram user id of the user. */
...
export const UserSetting = {
  encode(message: UserSetting, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.telegramUserId !== undefined) {
      writer.uint32(58).string(message.telegramUserId);
    }
    return writer;
  },
  ...
  fromPartial(object: DeepPartial<UserSetting>): UserSetting {
    ...
    message.telegramUserId = object.telegramUserId ?? undefined;
    return message;
  },
};
